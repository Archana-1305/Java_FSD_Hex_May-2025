...
public class CompanyController {
	...
	/* AIM      : To fetch all States(from enum)
	 * PATH     : /api/company/getAllStates
	 * METHOD   : GET
	 * RESPONSE : List of States in "package com.payrollmanagement.easypay.enums.States"
	 * */
	...
	/* AIM      : To fetch all Cities(from enum)
	 * PATH     : /api/company/getAllCities
	 * METHOD   : GET
	 * PARAM    : @RequestParam String state
	 * RESPONSE : List of Cities in "package com.payrollmanagement.easypay.enums.City"
	 * */
