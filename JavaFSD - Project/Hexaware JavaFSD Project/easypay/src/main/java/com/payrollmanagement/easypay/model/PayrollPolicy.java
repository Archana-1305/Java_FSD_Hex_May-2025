...
public class PayrollPolicy {
	...
	public Boolean getProfessionalTaxEnabled() {
		return professionalTaxEnabled;
	}

	public void setProfessionalTaxEnabled(Boolean professionalTaxEnabled) {
		this.professionalTaxEnabled = professionalTaxEnabled;
	}
